import { Eyebrow, Tag, Sticker, MascotSlot } from './ui';

function StatRow({ k, v }) {
  return (
    <div style={{
      display: 'flex', justifyContent: 'space-between', gap: 12,
      padding: '9px 0', borderBottom: '1px dashed rgba(247,243,239,.25)',
    }}>
  ...
  return (
    <section id="about" style={{ padding: '80px 30px', background: 'var(--ink)', color: 'var(--cream)', scrollMarginTop: 70 }}>
      <div style={{
        ...
        gridTemplateColumns: '.85fr 1.15fr', gap: 50, alignItems: 'start',
