...
import { ASSET, Eyebrow, Sticker, Btn } from './ui';
    ...
    <section id="contact" style={{ padding: '84px 30px', scrollMarginTop: 70 }}>
      <div style={{ maxWidth: 820, margin: '0 auto', textAlign: 'center', position: 'relative' }}>
        <div style={{ position: 'absolute', top: -10, left: '12%' }}>
          <Sticker rot={-14} bg="var(--teal-700)" fg="#fff" size={54}>✦</Sticker>
        </div>
        <div style={{ position: 'absolute', top: 20, right: '10%' }}>
          <Sticker rot={12} bg="var(--amber-900)" size={48}>★</Sticker>
        </div>
        ...
        <h2 style={{
          ...
          letterSpacing: '-.02em', margin: '16px 0 0',
        }}>
          Got a world that<br />needs{' '}
          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 600, color: 'var(--crimson-500)' }}>building?</span>
        </h2>
        ...
        <div style={{
          maxWidth: 560, margin: '30px auto 0', background: '#fff',
          border: '2.5px solid var(--ink)', borderRadius: 22, padding: 24,
          boxShadow: '6px 6px 0 var(--crimson-500)', textAlign: 'left',
        }}>
          {!sent ? (
            <div>
              <textarea
                ...
                style={{
                  ...
                  padding: '14px 16px', border: '2px solid var(--ink)', borderRadius: 14,
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 14, alignItems: 'center', flexWrap: 'wrap' }}>
                <input
                  ...
                  style={{
                    flex: '1 1 180px', fontFamily: 'var(--font-sans)', fontSize: 16,
...
export function Footer({ onCharacter }) {
  return (
    <footer style={{
      background: 'var(--ink)', color: 'var(--cream)', padding: '48px 30px',
