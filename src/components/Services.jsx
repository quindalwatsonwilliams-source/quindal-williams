...
const SERVICES = [
  { n: '01', t: 'Branding', nc: '#E72388', tint: 'rgba(231,35,136,0.05)', d: 'Identity systems, logotypes, and the rules that keep a brand feeling like itself everywhere.' },
  { n: '02', t: 'Creative Direction', nc: '#F8BB0B', tint: 'rgba(248,187,11,0.05)', d: 'The vision and the taste-keeping — concept, art direction, and making sure the whole thing sings.' },
  { n: '03', t: 'Campaigns', nc: '#E72388', tint: 'rgba(231,35,136,0.05)', d: 'Launch ideas with legs — concepts, key art, and rollout across the channels that matter.' },
  { n: '04', t: 'Packaging', nc: '#0E6771', tint: 'rgba(14,103,113,0.05)', d: 'Objects you want to keep. Structure, illustration, and the unboxing moment.' },
  { n: '05', t: 'Spatial / Experiential', nc: '#F8BB0B', tint: 'rgba(248,187,11,0.05)', d: 'Brand worlds you can walk through — booths, activations, and environments built to be felt.' },
];
