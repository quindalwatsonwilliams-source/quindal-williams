...
export function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    const fire = (immediate = false) =>
      document.dispatchEvent(new CustomEvent('loadingComplete', { detail: { immediate } }));
    ...
    path.style.transition = `stroke-dashoffset ${Math.round(900 * s)}ms cubic-bezier(0.4, 0, 0.2, 1)`;
  ...
  return (
    <div
      ...
      style={{
        ...
        background: '#3C0606', zIndex: 99999,
